def fibonacci(n):
 ...
 Arguments: n {integer} -- term
 Returns: term {integer}
    '''
...
def factorial(n):
    '''
 Calculates factorial of a number Accepts:
 n {int} -- input
...
def fibonacciAndFactorial(n):
    '''
 Returns the nth term of Fibonacci sequence and its factorial
 Accepts: n {int} -- an integer
 Returns [term, factorial] {list}
    '''
